CREATE TABLE IF NOT EXISTS well (
    filtration_type smallint REFERENCES water_supply_filtration_type (id), -- Indicates the type of filtration system used for water treatment
    ...
    asset_type smallint REFERENCES asset_type_water_device_supply_welltype (id) NOT NULL DEFAULT 0, -- Categorization of the type of water distribution asset
