CREATE TABLE IF NOT EXISTS backflow (
    ...
    asset_type smallint REFERENCES asset_type_water_assembly_backflow (id) NOT NULL DEFAULT 0, -- Categorization of the backflow asset based on its type
    ...
    locked smallint REFERENCES yes_no (id) DEFAULT 0, -- Indicates whether the asset is locked or accessible
