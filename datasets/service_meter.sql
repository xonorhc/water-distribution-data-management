CREATE TABLE IF NOT EXISTS service_meter (
    ...
    asset_type smallint REFERENCES asset_type_water_device_service_meter (id) NOT NULL DEFAULT 0, -- Categorization of the type of water distribution asset
    ...
    diameter numeric REFERENCES water_meter_diameter (id) DEFAULT 0, -- Measurement of the assets diameter
