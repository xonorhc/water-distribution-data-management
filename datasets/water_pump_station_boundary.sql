CREATE TABLE IF NOT EXISTS water_pump_station_boundary (
    ...
    asset_type smallint REFERENCES asset_type_structure_boundary_water_pump_station_boundary (id) NOT NULL DEFAULT 0, -- Categorization of the type of water distribution asset
