CREATE TABLE IF NOT EXISTS service_connection (
    ...
    asset_type smallint REFERENCES asset_type_water_device_service_connection (id) NOT NULL DEFAULT 0, -- Categorization of the service connection based on its type
