CREATE TABLE IF NOT EXISTS interconnect (
    ...
    emergency smallint REFERENCES yes_no (id), -- Indicates if the asset is for emergency use only
    object_id serial PRIMARY KEY, -- Unique identifier for each feature in the layer
    asset_type smallint REFERENCES water_interconnect_connection_type (id) NOT NULL DEFAULT 0, -- Type of connection associated with the asset
