CREATE TABLE IF NOT EXISTS pump (
    ...
    diameter smallint DEFAULT 0, -- Measurement of the inlet diameter of the pump
    secondary_diameter smallint DEFAULT 0, -- Measurement od the outlet diameter of the pump
    ...
    FOREIGN KEY (diameter) REFERENCES water_pump_diameter (code),
    FOREIGN KEY (secondary_diameter) REFERENCES water_pump_diameter (code),
