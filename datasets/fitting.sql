CREATE TABLE IF NOT EXISTS fitting (
    ...
    asset_type smallint REFERENCES asset_type_water_junction_fitting (id) NOT NULL DEFAULT 0, -- Categorization of the type of water distribution asset
    ...
    diameter smallint REFERENCES water_fitting_diameter (id) DEFAULT 0, -- Measurement of the fittings diameter
